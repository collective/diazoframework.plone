...
$(document).ready(function () {
    var $nav, $wrapper, $dropnav, 
        navHeight, itemHeight, switchNav, switchCheck;
    ...
    $dropnav = $('<ul id="dropnav" class="inactive" />').append(
        '<li><a href="#" id="toggleNav">Show<span><span/></span></a></li>',
        $nav.children().clone().removeAttr('id'));
    ...
    $(window).resize(function () { switchCheck($nav, $dropnav, itemHeight) });
});
